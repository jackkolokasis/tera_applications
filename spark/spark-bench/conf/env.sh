...
DATA_HDFS=file:///spare/s1/perpap/datasets_1024/SparkBench
...
#SPARK_VERSION=3.3.0
[ -z "$SPARK_HOME" ] &&  export SPARK_HOME=/spare/s1/perpap/tera_applications/spark/scripts/../../spark/spark-3.3.0
