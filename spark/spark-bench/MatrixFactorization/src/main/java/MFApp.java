...
public class MFApp {
    ...
    public static void main(String[] args) {
        ...
        if (storage_level.equals("DISK_ONLY"))
        {
            ratings.persist(StorageLevel.DISK_ONLY());
        }
        ...
        {
            ratings.persist(StorageLevel.OFF_HEAP());
        }
        else if (storage_level.equals("MEMORY_ONLY"))
        {
            ratings.persist(StorageLevel.MEMORY_ONLY());
        } 
        else 
        {
            ratings.cache();
        ...
        if (storage_level.equals("DISK_ONLY"))
        {
            parsed_data.persist(StorageLevel.DISK_ONLY());
        }
        else if (storage_level.equals("MEMORY_AND_DISK"))
        {
        ...
        if (storage_level.equals("DISK_ONLY")) {
            userProducts.persist(StorageLevel.DISK_ONLY());
        }else if (storage_level.equals("MEMORY_AND_DISK")) {
