...
public class StorageLevels {
  ...
  public static final StorageLevel MEMORY_AND_DISK_SER_2 = create(true, true, false, false, false,
                                                                    2);
  ...
  public static StorageLevel create(
    ...
    int replication) {
    return StorageLevel.apply(useDisk, useMemory, useOffHeap, usePmemOffHeap, deserialized,
                              replication);
  }
}
